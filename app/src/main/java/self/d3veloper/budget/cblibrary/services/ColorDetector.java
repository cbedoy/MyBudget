...
public class ColorDetector
{
        ...
        private static final String LOG_TAG = ColorDetector.class.getSimpleName();
        ...
        public ColorDetector(Bitmap bitmap) {
    ...
    private class HashBag<K> extends HashMap<K, Integer> {
