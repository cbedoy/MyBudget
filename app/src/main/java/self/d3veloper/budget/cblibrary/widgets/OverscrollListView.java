package self.d3veloper.budget.cblibrary.widgets;
...
public class OverscrollListView extends ListView implements OnScrollListener, View.OnTouchListener, AdapterView.OnItemSelectedListener {

    protected static float BREAKSPEED = 4f;
    ...
    /** This should be called after you finish populating the listview ! This includes any calls to {@link android.widget.Adapter#()} and obviously every time you re-populate the listview. */
